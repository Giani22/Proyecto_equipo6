...
public class Logica {
	...
	public boolean guardarPrestamoLibro(Solicitante modelo) {
		boolean resultado = false;
		if(modelo.getCi()>0) {
		//	bd.guardarPrestamoLibroBD(modelo);
			resultado = true;
		}
		return resultado;
	...
	public void elimCeiablita(int Numero) {
	        bd.elimCeiablitaBD(Numero);

	        
	}


	public void elimLibroPrestamo(String isbn) {
		   bd.elimLibroPrestamoBD(isbn);
		}
		
			
		
		public void elimCeiablitaPrestamo(int Numero) {
		        bd.elimCeiablitaPrestamoBD(Numero);
