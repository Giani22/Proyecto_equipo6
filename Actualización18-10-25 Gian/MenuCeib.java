	...
	public MenuCeib() {
		...
		btnEliminar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (fila != -1) {
					int Numero = Integer.parseInt(tabla.getValueAt(fila, 0).toString());
		...
		btnListadoPrestamo.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				panelCentroCompleto.remove(panelTabla);

				Gestor.listarPrestamoCeib(modeloPres);
				panelCentroCompleto.revalidate();
