...
public class MySQL {
	...
	public void elimCeibalitaBD(int Numero) {
	...
	public void modificarLibroBD (String isbn, String titulo, String autor, String materia, int copia) {
	    	    String sentencia = "UPDATE libro SET titulo = ?, autor = ?, materia = ?, copias = ? WHERE isbn = ?";
	    ...
	    try (Connection conexion = getConnection(); 
	        ...
	        if (filasAfectadas > 0) {
	            ...
	            JOptionPane.showMessageDialog(null, "No se encontró el libro con ISBN: " + isbn + " o los datos son los mismos");
	        }
	...
	//	public void altaMontoBD(String monto) {
