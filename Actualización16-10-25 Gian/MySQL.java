...
public void guardarCeibalitaBD(Datos_Laptops ceibalita) {
	...
	String sentencia = "INSERT INTO pideLibro(ci, nombre, apellido, materia, grupo, isbn) VALUES('" + soli.getCi() + "','"  + soli.getNombre() + "','" + soli.getApellido() + "','" + soli.getMateria()+"','" + soli.getGrupo()+"','" + soli.getIsbn() + "');";
	String sentencia2 = "INSERT INTO personas(ci, nombre, apellido, materia, grupo) VALUES('" + soli.getCi() +"','" + soli.getNombre() + "','" + soli.getApellido() + "','"  + soli.getMateria()+ "','" + soli.getGrupo()+ "');";
	...
	public void guardarPrestamoCeibBD(Solicitante2 soli) {
		...
		String sentencia = "INSERT INTO pideCeibalita(ci ,nombre, apellido, materia, grupo, numero) VALUES('" + soli.getCi() +"','"+ soli.getNombre() + "','" + soli.getApellido() + "','" + soli.getMateria()+"','" + soli.getGrupo()+"','" + soli.getNumero() + "');";
		String sentencia2 = "INSERT INTO personas(ci, nombre, apellido, materia, grupo) VALUES('" + soli.getCi() +"','"+ soli.getNombre() + "','" + soli.getApellido() + "','" + soli.getMateria()+"','" + soli.getGrupo()+ "');";
		System.out.println(sentencia);
		System.out.println(sentencia2);
			try {
	...
	public void elimLibroBD(Libro lib1) {
		
		String sentencia = "DELETE From libros Where ci = " + lib1.getIsbn();
